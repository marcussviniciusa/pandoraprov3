  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Cores jurídicas
        "juridico-azul": "hsl(var(--juridico-azul))",
        "juridico-verde": "hsl(var(--juridico-verde))",
        "juridico-dourado": "hsl(var(--juridico-dourado))",
        "juridico-vermelho": "hsl(var(--juridico-vermelho))",
        "juridico-cinza": "hsl(var(--juridico-cinza))",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "border-beam": "border-beam calc(var(--duration, 15s) * 1s) infinite linear",
